...
public class TaskQuadruple {
	...
	public Boolean equals(TaskQuadruple tp) {
		if (tp.getPlan() == null && this.getPlan() == null) {
			return ((this.getTask().equals(tp.getTask()) && this.getSync()
					.equals(this.getSync())) && this.getId().equals(tp.getId()));

		}
		return ((this.getTask().equals(tp.getTask()) && this.getSync().equals(
				this.getSync()))
				&& this.getId().equals(tp.getId()) && this.getPlan().equals(
				tp.getPlan()));
	}
