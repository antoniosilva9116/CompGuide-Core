...
/**
 * Created with IntelliJ IDEA. User: tiago Date: 31-07-2013 Guidelinename: 13:41
 * To change this template use File | Settings | File Templates.
 */
public class GuidelineManager {
	public static final String ALL_FIELDS = "authorship" + ",guidelinename"
			+ ",versionnumber" + ",dateofupdate" + ",dateofcreation"
			+ ",identifier" + ",description" + ",idguideline";

	public static final String FIELDS = "authorship" + ",guidelinename"
			+ ",versionnumber" + ",dateofupdate" + ",dateofcreation"
			+ ",identifier" + ",description";

	public static final String[] ALL_FIELDS_ARRAY = { "authorship=",
			",guidelinename=", ",versionnumber=", ",dateofupdate=",
			",dateofcreation=", ",description=", ",identifier=",
			",idguideline=" };
