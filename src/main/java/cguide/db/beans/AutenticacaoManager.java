...
/**
 * Handles database calls (save, load, count, etc...) for the autenticacao
 * table.
 * 
 * @author sql2java
 */
public class AutenticacaoManager {
	 ...
	 */
	private static final String[] FULL_FIELD_NAMES = { "autenticacao.duracao",
			"autenticacao.auth", "autenticacao.utilizador_id",
			"autenticacao.id" };

	/**
	 * Contains all the fields of the autenticacao table.
	 */
	public static final String[] FIELD_NAMES = { "duracao", "auth",
			"utilizador_id", "id" };
	 ...
	 * Field that contains the comma separated fields of the autenticacao table.
	 */
	public static final String ALL_FIELDS = "duracao" + ",auth"
			+ ",utilizador_id" + ",id";
	...
	public AutenticacaoBean loadByPrimaryKey(Integer id) throws DAOException {
		...
		try {
			...
			StringBuilder sql = new StringBuilder("SELECT " + ALL_FIELDS
					+ " FROM autenticacao WHERE id=?");
			...
			List<AutenticacaoBean> pReturn = this
					.loadByPreparedStatementAsList(ps);
			if (pReturn.size() == 0) {
	...
	public int deleteByPrimaryKey(Integer id) throws DAOException {
		...
		try {
			...
			StringBuilder sql = new StringBuilder(
					"DELETE FROM autenticacao WHERE id=?");
			ps = c.prepareStatement(sql.toString(),
					ResultSet.TYPE_SCROLL_INSENSITIVE,
					ResultSet.CONCUR_READ_ONLY);
			if (id == null) {
	...
	// ////////////////////////////////////
	/**
	 * Retrieves the UtilizadorBean object from the autenticacao.utilizador_id
	 * field.
	 *
	 * @param bean
	 *            the AutenticacaoBean
	 * @return the associated UtilizadorBean bean
	 * @throws DAOException
	 */
	// //3.2 GET IMPORTED VALUES
	// public UserBean getUtilizadorBean(AutenticacaoBean bean) throws
	// DAOException
	// {
	 ...
	 *
	 * @param bean
	 *            the AutenticacaoBean object to use
	 * @param beanToSet
	 *            the UtilizadorBean object to associate to the AutenticacaoBean
	 * @return the associated UtilizadorBean bean
	 * @throws Exception
	 */
	// 4.2 ADD IMPORTED VALUE
	public UserBean addUserBean(UserBean beanToSet, AutenticacaoBean bean)
			throws Exception {
	 ...
	 */
	// 5.2 SET IMPORTED
	// public UserBean setUtilizadorBean(AutenticacaoBean bean, UserBean
	// beanToSet) throws Exception
	// {
	 ...
	 * @param numRows
	 *            the number of rows to be retrieved (all rows = a negative
	 *            number)
	 * @return an array of AutenticacaoManager bean
	 * @throws DAOException
	 */
	// 6
	public AutenticacaoBean[] loadAll(int startRow, int numRows)
			throws DAOException {
	 ...
	 */
	// 6
	public List<AutenticacaoBean> loadAllAsList(int startRow, int numRows)
			throws DAOException {
	 ...
	 */
	// 7
	public List<AutenticacaoBean> loadByWhereAsList(String where)
			throws DAOException {
		return this.loadByWhereAsList(where, null);
	}

	/**
	 * Retrieves an array of AutenticacaoBean given a sql where clause, and a
	 * list of fields. It is up to you to pass the 'WHERE' in your where
	 * clausis.
	 *
	 * @param where
	 *            the sql 'WHERE' clause
	 ...
	 */
	// 8
	public AutenticacaoBean[] loadByWhere(String where, int[] fieldList)
			throws DAOException {
		return this.loadByWhere(where, fieldList, 1, -1);
	}

	/**
	 * Retrieves a list of AutenticacaoBean given a sql where clause, and a list
	 * of fields. It is up to you to pass the 'WHERE' in your where clausis.
	 *
	 * @param where
	 *            the sql 'WHERE' clause
	 * @param fieldList
	...
	// 8
	public List<AutenticacaoBean> loadByWhereAsList(String where,
			int[] fieldList) throws DAOException {
		return this.loadByWhereAsList(where, fieldList, 1, -1);
	}

	/**
	 * Retrieves an array of AutenticacaoBean given a sql where clause and a
	 * list of fields, and startRow and numRows. It is up to you to pass the
	...
	// 9
	public AutenticacaoBean[] loadByWhere(String where, int[] fieldList,
			int startRow, int numRows) throws DAOException {
		return (AutenticacaoBean[]) this.loadByWhereAsList(where, fieldList,
				startRow, numRows).toArray(new AutenticacaoBean[0]);
	}

	/**
	 * Retrieves a list of AutenticacaoBean given a sql where clause and a list
	 * of fields, and startRow and numRows. It is up to you to pass the 'WHERE'
	 * in your where clausis.
	 *
	 * @param where
	 *            the sql 'where' clause
	 * @param startRow
	...
	// 9
	public List<AutenticacaoBean> loadByWhereAsList(String where,
			int[] fieldList, int startRow, int numRows) throws DAOException {
		StringBuffer sql = new StringBuffer(128);
		if (fieldList == null) {
			sql.append("SELECT ").append(ALL_FIELDS)
					.append(" FROM autenticacao ").append(where);
		} else {
			sql.append("SELECT ");
	...
	/**
	 * Deletes rows from the autenticacao table using a 'where' clause. It is up
	 * to you to pass the 'WHERE' in your where clausis. <br>
	 ...
	 *
	 * @param bean
	 *            the AutenticacaoBean bean to be saved
	...
	public AutenticacaoBean insert(AutenticacaoBean bean) throws DAOException {
		...
		try {
			...
			if (!bean.isIdModified()) {
				...
				// StringBuilder("SELECT MAX(id) AS MAX+1 FROM autenticacao");
				// //
				//
	...
	/**
	 * Update the AutenticacaoBean bean record in the database according to the
	 * changes.
	 *
	 * @param bean
	 *            the AutenticacaoBean bean to be updated
	...
	public AutenticacaoBean update(AutenticacaoBean bean) throws DAOException {
		...
		try {
			...
			if (bean.getId() == null) {
				ps.setNull(++_dirtyCount, Types.INTEGER);
			} else {
				Manager.setInteger(ps, ++_dirtyCount, bean.getId());
			}
			ps.executeUpdate();
			bean.resetIsModified();
	 ...
	 *
	 * @param beans
	 *            the AutenticacaoBean bean table to be saved
	 * @return the saved AutenticacaoBean array.
	 * @throws DAOException
	 */
	// 15
	public AutenticacaoBean[] save(AutenticacaoBean[] beans)
			throws DAOException {
	 ...
	 */
	// 15
	public List<AutenticacaoBean> save(List<AutenticacaoBean> beans)
			throws DAOException {
		for (AutenticacaoBean bean : beans) {
			this.save(bean);
		}
	 ...
	 *
	 * @param beans
	 *            the AutenticacaoBean bean table to be inserted
	 * @return the saved AutenticacaoBean array.
	 * @throws DAOException
	 */
	// 16
	public AutenticacaoBean[] insert(AutenticacaoBean[] beans)
			throws DAOException {
	 ...
	 */
	// 16
	public List<AutenticacaoBean> insert(List<AutenticacaoBean> beans)
			throws DAOException {
		return this.save(beans);
	}
	 ...
	 */
	// 17
	public AutenticacaoBean[] update(AutenticacaoBean[] beans)
			throws DAOException {
		return this.save(beans);
	}
	 ...
	 */
	// 17
	public List<AutenticacaoBean> update(List<AutenticacaoBean> beans)
			throws DAOException {
		return this.save(beans);
	}
	 ...
	 *
	 * @param bean
	 *            the AutenticacaoBean bean to look for
	 * @return the bean matching the template
	 * @throws DAOException
	 */
	// 18
	public AutenticacaoBean loadUniqueUsingTemplate(AutenticacaoBean bean)
			throws DAOException {
	 ...
	 *
	 * @param bean
	 *            the AutenticacaoBean template to look for
	 * @return all the AutenticacaoBean matching the template
	 * @throws DAOException
	 */
	// 19
	public AutenticacaoBean[] loadUsingTemplate(AutenticacaoBean bean)
			throws DAOException {
	 ...
	 */
	// 19
	public List<AutenticacaoBean> loadUsingTemplateAsList(AutenticacaoBean bean)
			throws DAOException {
		return this.loadUsingTemplateAsList(bean, 1, -1);
	}

	/**
	 * Loads an array of AutenticacaoBean from a template one, given the start
	...
	/**
	 * Loads a list of AutenticacaoBean from a template one, given the start row
	 * and number of rows.
	 *
	 * @param bean
	 *            the AutenticacaoBean template to look for
	 ...
	 */
	// 20
	public List<AutenticacaoBean> loadUsingTemplateAsList(
			AutenticacaoBean bean, int startRow, int numRows)
			throws DAOException {
	...
	// 20
	public AutenticacaoBean[] loadUsingTemplate(AutenticacaoBean bean,
			int startRow, int numRows, int searchType) throws DAOException {
		return (AutenticacaoBean[]) this.loadUsingTemplateAsList(bean,
				startRow, numRows, searchType).toArray(new AutenticacaoBean[0]);
	}
	...
	// 20
	public List<AutenticacaoBean> loadUsingTemplateAsList(
			AutenticacaoBean bean, int startRow, int numRows, int searchType)
			throws DAOException {
		//
		Connection c = null;
		PreparedStatement ps = null;
		...
		try {
			...
			ps = c.prepareStatement(sql.toString(), scrollType,
					ResultSet.CONCUR_READ_ONLY);
			this.fillPreparedStatement(ps, bean, searchType);

			ps.executeQuery();
			return this.loadByPreparedStatementAsList(ps, null, startRow,
					numRows);
		} catch (SQLException e) {
			throw new ObjectRetrievalException(e);
		} finally {
	 ...
	 *
	 * @param bean
	 *            the AutenticacaoBean object(s) to be deleted
	...
	/**
	 * Retrieves an array of AutenticacaoBean using the idx_f2fff4c65f015bce
	 * index.
	 *
	 * @param utilizadorId
	 *            the utilizador_id column's value filter.
	 * @return an array of AutenticacaoBean
	 * @throws DAOException
	 */
	public AutenticacaoBean[] loadByidx_f2fff4c65f015bce(Long utilizadorId)
			throws DAOException {
		return (AutenticacaoBean[]) this.loadByidx_f2fff4c65f015bceAsList(
				utilizadorId).toArray(new AutenticacaoBean[0]);
	}

	/**
	 * Retrieves a list of AutenticacaoBean using the idx_f2fff4c65f015bce
	 * index.
	 *
	 * @param utilizadorId
	 *            the utilizador_id column's value filter.
	 ...
	 * @throws DAOException
	 */
	public List<AutenticacaoBean> loadByidx_f2fff4c65f015bceAsList(
			Long utilizadorId) throws DAOException {
	 ...
	 * @throws DAOException
	 */
	public int deleteByidx_f2fff4c65f015bce(Long utilizadorId)
			throws DAOException {
		AutenticacaoBean bean = this.createAutenticacaoBean();
		bean.setUtilizadorId(utilizadorId);
	...
	/**
	 * Retrieves the number of rows of the table autenticacao with a 'where'
	 * clause. It is up to you to pass the 'WHERE' in your where clausis.
	 *
	 * @param where
	...
	/**
	 * Retrieves the number of rows of the table autenticacao with a prepared
	 * statement.
	 *
	 * @param ps
	 ...
	 */
	// 26
	private int countByPreparedStatement(PreparedStatement ps)
			throws DAOException {
		ResultSet rs = null;
		try {
			int iReturn = -1;
	 ...
	 *
	 * @param bean
	 *            the AutenticacaoBean bean to look for ant count
	 * @return the number of rows returned
	 * @throws DAOException
	 */
	// 27
	...
	/**
	 * count the number of elements of a specific AutenticacaoBean bean , given
	 * the start row and number of rows.
	 *
	 * @param bean
	 *            the AutenticacaoBean template to look for and count
	 * @param startRow
	 *            the start row to be used (first row = 1, last row=-1)
	 * @param numRows
	 *            the number of rows to be retrieved (all rows = a negative
	 ...
	 */
	// 20
	public int countUsingTemplate(AutenticacaoBean bean, int startRow,
	...
	/**
	 * count the number of elements of a specific AutenticacaoBean bean given
	 * the start row and number of rows and the search type
	 *
	 * @param bean
	 *            the AutenticacaoBean template to look for
	 * @param startRow
	...
	// 20
	public int countUsingTemplate(AutenticacaoBean bean, int startRow,
			int numRows, int searchType) throws DAOException {
		Connection c = null;
		PreparedStatement ps = null;
		StringBuilder sql = new StringBuilder(
				"SELECT COUNT(*) AS MCOUNT FROM autenticacao");
		StringBuilder sqlWhere = new StringBuilder("");
	...
	/**
	 * fills the given StringBuilder with the sql where clausis constructed
	 * using the bean and the search type
	 * 
	 * @param sqlWhere
	 *            the StringBuilder that will be filled
	 * @param bean
	 ...
	 */
	protected int fillWhere(StringBuilder sqlWhere, AutenticacaoBean bean,
			int searchType) {
		if (bean == null) {
			return 0;
		}
		...
		try {
			...
			if (bean.isAuthModified()) {
				...
				if (bean.getAuth() == null) {
					...
					sqlWhere.append((sqlWhere.length() == 0) ? " " : " AND ")
							.append("auth ").append(sqlEqualsOperation)
							.append("?");
				}
			}
			if (bean.isUtilizadorIdModified()) {
				...
				if (bean.getUtilizadorId() == null) {
					sqlWhere.append((sqlWhere.length() == 0) ? " " : " AND ")
							.append("utilizador_id IS NULL");
				} else {
					sqlWhere.append((sqlWhere.length() == 0) ? " " : " AND ")
							.append("utilizador_id = ?");
				}
			}
			if (bean.isIdModified()) {
				_dirtyCount++;
	 ...
	 * @throws DAOException
	 */
	protected int fillPreparedStatement(PreparedStatement ps,
			AutenticacaoBean bean, int searchType) throws DAOException {
		if (bean == null) {
			return 0;
		}
		int _dirtyCount = 0;
		try {
			if (bean.isDuracaoModified()) {
				//
				if (bean.getDuracao() == null) {
					ps.setNull(++_dirtyCount, Types.TIMESTAMP);
				} else {
					ps.setTimestamp(++_dirtyCount, new Timestamp(bean
							.getDuracao().getTime()));
				}
			}
			if (bean.isAuthModified()) {
			...
			if (bean.isUtilizadorIdModified()) {
				//
				if (bean.getUtilizadorId() == null) {
					ps.setNull(++_dirtyCount, Types.BIGINT);
				} else {
					Manager.setLong(ps, ++_dirtyCount, bean.getUtilizadorId());
				}
			}
			if (bean.isIdModified()) {
				//
	 ...
	 */
	// 28
	public AutenticacaoBean[] decodeResultSet(ResultSet rs, int[] fieldList,
			int startRow, int numRows) throws DAOException {
		return (AutenticacaoBean[]) this.decodeResultSetAsList(rs, fieldList,
				startRow, numRows).toArray(new AutenticacaoBean[0]);
	}
	 ...
	 */
	// 28
	public List<AutenticacaoBean> decodeResultSetAsList(ResultSet rs,
			int[] fieldList, int startRow, int numRows) throws DAOException {
	...
	/**
	 * Transforms a ResultSet iterating on the autenticacao on a
	 * AutenticacaoBean bean.
	 *
	 * @param rs
	...
	/**
	 * Transforms a ResultSet iterating on the autenticacao table on a
	 * AutenticacaoBean bean according to a list of fields.
	 *
	 * @param rs
	 *            the ResultSet to be transformed
	 * @param fieldList
	 ...
	 */
	// 30
	public AutenticacaoBean decodeRow(ResultSet rs, int[] fieldList)
			throws DAOException {
		AutenticacaoBean bean = this.createAutenticacaoBean();
		int pos = 0;
		try {
	...
	/**
	 * Transforms a ResultSet iterating on the autenticacao on a
	 * AutenticacaoBean bean using the names of the columns
	 *
	 * @param rs
	 *            the ResultSet to be transformed
	 * @return bean resulting AutenticacaoBean bean
	 ...
	 */
	// 32
	public AutenticacaoBean[] loadByPreparedStatement(PreparedStatement ps)
			throws DAOException {
	 ...
	 */
	// 32
	public List<AutenticacaoBean> loadByPreparedStatementAsList(
	...
	public AutenticacaoBean[] loadByPreparedStatement(PreparedStatement ps,
			int[] fieldList) throws DAOException {
		return (AutenticacaoBean[]) this.loadByPreparedStatementAsList(ps,
				fieldList).toArray(new AutenticacaoBean[0]);
	}
	...
	// 33
	public List<AutenticacaoBean> loadByPreparedStatementAsList(
			PreparedStatement ps, int[] fieldList) throws DAOException {
		ResultSet rs = null;
	...
	/**
	 * Loads all the elements using a prepared statement specifying a list of
	 * fields to be retrieved, and specifying the start row and the number of
	 * rows.
	 *
	 * @param ps
	 *            the PreparedStatement to be used
	...
	// 34
	public List<AutenticacaoBean> loadByPreparedStatementAsList(
			PreparedStatement ps, int[] fieldList, int startRow, int numRows)
			throws DAOException {
		ResultSet rs = null;
		try {
			rs = ps.executeQuery();
	 ...
	 *
	 * @param bean
	 *            the AutenticacaoBean bean to be deleted
	 */
