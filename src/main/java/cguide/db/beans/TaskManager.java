...
public class TaskManager {
	public static final String ALL_FIELDS = "time" + ",nextTask" + ",taskPlan"
			+ ",taskIdentifier" + ",taskDescription" + ",taskFormat"
			+ ",taskType" + ",idguideexec" + ",idtask";
	public static final String FIELDS = "time" + ",nextTask" + ",taskPlan"
			+ ",taskIdentifier" + ",taskDescription" + ",taskFormat"
			+ ",taskType" + ",idguideexec";
	public static final String[] ALL_FIELDS_ARRAY = { "time=", ",nextTask=",
			",taskPlan=", ",taskIdentifier=", ",taskDescription=",
			",taskFormat=", ",taskType=", ",idguideexec=", ",idtask=" };
