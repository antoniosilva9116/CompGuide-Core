...
public class ObservationBean implements Serializable {
	...
	/**
	 * Prefered methods to create a ObservationBean is via the
	 * createUtilizadorBean method in UtilizadorManager or via the factory class
	 * UtilizadorFactory create method
	 */
	...
	public Map<String, String> getDictionnary() {
		...
		dictionnary.put("idtask", getIdtask() == null ? "" : getIdtask()
				.toString());
		dictionnary.put("time", getTime() == null ? "" : getTime());
		dictionnary.put("unit", getUnit() == null ? "" : getUnit());
		dictionnary.put("identifier", getIdentifier() == null ? ""
				: getIdentifier());
		dictionnary.put("parametervalue", getParametervalue() == null ? ""
				: getParametervalue());
		dictionnary.put("variablename", getVariablename() == null ? ""
				: getVariablename());
		dictionnary.put("parameteridentifier",
				getParameteridentifier() == null ? ""
						: getParameteridentifier());
		dictionnary.put("parameter", getParameter() == null ? ""
				: getParameter());
		dictionnary.put("idobservation", getIdobservation() == null ? ""
				: getIdobservation().toString());
		dictionnary.put("isnumeric", getIsnumeric() == null ? ""
				: getIsnumeric().toString());
		return dictionnary;
	}
	...
	public String getValue(String column) {
		if (null == column || "".equals(column)) {
			return "";
		} else if ("idtask".equalsIgnoreCase(column)
				|| "idtask".equalsIgnoreCase(column)) {
			return getIdtask() == null ? "" : getIdtask().toString();
		} else if ("time".equalsIgnoreCase(column)
				|| "time".equalsIgnoreCase(column)) {
			return getTime() == null ? "" : getTime();
		} else if ("unit".equalsIgnoreCase(column)
				|| "unit".equalsIgnoreCase(column)) {
			return getUnit() == null ? "" : getUnit();
		} else if ("identifier".equalsIgnoreCase(column)
				|| "identifier".equalsIgnoreCase(column)) {
			return getIdentifier() == null ? "" : getIdentifier();
		} else if ("variablename".equalsIgnoreCase(column)
				|| "variablename".equalsIgnoreCase(column)) {
			return getVariablename() == null ? "" : getVariablename();
		} else if ("parameteridentifier".equalsIgnoreCase(column)
				|| "parameteridentifier".equalsIgnoreCase(column)) {
			return getParameteridentifier() == null ? ""
					: getParameteridentifier();
		} else if ("parameter".equalsIgnoreCase(column)
				|| "parameter".equalsIgnoreCase(column)) {
			return getParameter() == null ? "" : getParameter();
		} else if ("idobservation".equalsIgnoreCase(column)
				|| "idobservation".equalsIgnoreCase(column)) {
			return getIdobservation() == null ? "" : getIdobservation()
					.toString();
		} else if ("isnumeric".equalsIgnoreCase(column)
				|| "isnumeric".equalsIgnoreCase(column)) {
			return getIdobservation() == null ? "" : getIdobservation()
					.toString();
		}
		return "";
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(getIdtask(), obj.getIdtask())
				...
				.append(getIsnumeric(), obj.getIsnumeric()).isEquals();
	}
	 ...
	 */
	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973).append(getIdtask())
				.append(getTime()).append(getUnit()).append(getIdentifier())
				.append(getParametervalue()).append(getVariablename())
				.append(getParameteridentifier()).append(getParameter())
				.append(getIdobservation()).append(getIsnumeric()).toHashCode();
	}
	 ...
	 * ToStringStyle.NO_FIELD_PARAMETERS_STYLE</li> <li>
	 * ToStringStyle.SHORT_PREFIX_STYLE</li> <li>ToStringStyle.SIMPLE_STYLE</li>
	 */
	public String toString(ToStringStyle style) {
		return new ToStringBuilder(this, style).append("idtask", getIdtask())
				.append("time", getTime()).append("unit", getUnit())
				...
				.append("isnumeric", getIsnumeric()).toString();
	}

	public int compareTo(Object object) {
		ObservationBean obj = (ObservationBean) object;
		return new CompareToBuilder().append(getIdtask(), obj.getIdtask())
				.append(getTime(), obj.getTime())
				.append(getUnit(), obj.getUnit())
				.append(getIdentifier(), obj.getIdentifier())
				.append(getParametervalue(), obj.getParametervalue())
				...
				.append(getParameter(), obj.getParameter())
				.append(getIdobservation(), obj.getIdobservation())
				.append(getIsnumeric(), obj.getIsnumeric()).toComparison();
	}
}
