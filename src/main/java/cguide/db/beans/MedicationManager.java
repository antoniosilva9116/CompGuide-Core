...
public class MedicationManager {
	public static final String ALL_FIELDS = "time" + ",idtask" + ",description"
			+ ",activeingredient" + ",dosage" + ",pharmaceuticalform"
			+ ",posology" + ",unit" + ",idmedication";
	public static final String FIELDS = "time" + ",idtask" + ",description"
			+ ",activeingredient" + ",dosage" + ",pharmaceuticalform"
			+ ",posology" + ",identifier";
	public static final String[] ALL_FIELDS_ARRAY = { "time=", ",idtask=",
			",description=", ",activeingredient=", ",dosage=",
			",pharmaceuticalform=", ",posology=", ",unit=", "idmedication=" };
