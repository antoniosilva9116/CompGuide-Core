...
public class GeneratedTaskBean implements Serializable {
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(getIdsync(), obj.getIdsync())
	...
	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973).append(getIdsync())
				.append(getIdgeneratedtask()).append(getIdplan())
	...
	public String toString(ToStringStyle style) {
		return new ToStringBuilder(this, style).append("idtask", getIdsync())
	...
	public int compareTo(Object object) {
		GeneratedTaskBean obj = (GeneratedTaskBean) object;
		return new CompareToBuilder().append(getIdsync(), obj.getIdsync())
				.append(getIdplan(), obj.getIdplan())
