...
public class TaskBean implements Serializable {
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(getIdtask(), obj.getIdtask())
				...
				.append(getNextTask(), obj.getNextTask()).isEquals();
	}
	...
	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973).append(getIdtask())
				.append(getTime()).append(getTaskIdentifier())
				.append(getTaskDescription()).append(getTaskFormat())
				.append(getTaskType()).append(getIdguideexec())
				.append(getTaskPlan()).append(getNextTask()).toHashCode();
	}
	...
	public String toString(ToStringStyle style) {
		return new ToStringBuilder(this, style).append("idtask", getIdtask())
				...
				.append("nextTask", getNextTask()).toString();
	}
	...
	public int compareTo(Object object) {
		...
		return new CompareToBuilder().append(getIdtask(), obj.getIdtask())
				...
				.append(getIdguideexec(), obj.getIdguideexec())
				.append(getTaskPlan(), obj.getTaskPlan())
				.append(getNextTask(), obj.getNextTask()).toComparison();
	}
