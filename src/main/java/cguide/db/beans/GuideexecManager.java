...
public class GuideexecManager {
	public static final String ALL_FIELDS = "time" + ",start" + ",completed"
			+ ",description" + ",nextTasks" + ",idguideline" + ",iduser"
			+ ",idpatient" + ",idguideexec";

	public static final String FIELDS = "time" + ",start" + ",completed"
			+ ",description" + ",nextTasks" + ",idguideline" + ",iduser"
			+ ",idpatient";

	public static final String[] ALL_FIELDS_ARRAY = { ",time=", ",start=",
			",completed=", ",nextTasks=", ",description=", ",idguideline=",
			",iduser=", ",idpatient=", "idguideexec=" };
	...
	public GuideexecBean getGuideexecBeanByID(String id) {
		...
		GuideexecBean bean = GuideexecManager.getInstance()
				.createGuideexecBean();
		ResultSet rs = null;
	...
	public GuideexecList getGuidelineListActive(String user) {
		...
		try {
			c = this.getConnection();
			sql = new StringBuilder();
			sql.append("SELECT * FROM guideexec WHERE completed="
					+ Boolean.FALSE + " AND iduser=" + user
					+ " ORDER BY idguideexec DESC");
			statement = c.prepareStatement(sql.toString());
			rs = statement.executeQuery();
