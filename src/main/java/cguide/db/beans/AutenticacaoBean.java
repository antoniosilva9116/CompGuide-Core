 ...
 * @author sql2java
 */
public class AutenticacaoBean implements Serializable, GeneratedBean {
	...
	/**
	 * Prefered methods to create a AutenticacaoBean is via the
	 * createAutenticacaoBean method in AutenticacaoManager or via the factory
	 * class AutenticacaoFactory create method
	 */
	protected AutenticacaoBean() {
	}

	/**
	 * Getter method for duracao. <br>
	 ...
	 *
	 * @param newVal
	 *            the new value to be assigned to duracao
	 */
	...
	/**
	 * Determines if the duracao has been initialized. <br>
	...
	/**
	 * Setter method for auth. <br>
	 * The new value is set only if compareTo() says it is different, or if one
	 * of either the new value or the current value is null. In case the new
	 * value is different, it is set and the field is marked as 'modified'.
	 *
	 * @param newVal
	 *            the new value to be assigned to auth
	 */
	...
	/**
	 * Determines if the auth has been initialized. <br>
	 * It is useful to determine if a field is null on purpose or just because
	 * it has not been initialized.
	 *
	 * @return true if the field has been initialized, false otherwise
	...
	/**
	 * Getter method for utilizadorId. <br>
	 * Meta Data Information (in progress):
	 * <ul>
	...
	/**
	 * Setter method for utilizadorId. <br>
	 * The new value is set only if compareTo() says it is different, or if one
	 * of either the new value or the current value is null. In case the new
	 * value is different, it is set and the field is marked as 'modified'.
	 *
	 * @param newVal
	 *            the new value to be assigned to utilizadorId
	 */
	public void setUtilizadorId(Long newVal) {
		if ((newVal != null && utilizadorId != null && (newVal
				.compareTo(utilizadorId) == 0))
	...
	/**
	 * Determines if the utilizadorId has been initialized. <br>
	 * It is useful to determine if a field is null on purpose or just because
	 * it has not been initialized.
	 *
	 * @return true if the field has been initialized, false otherwise
	...
	/**
	 * Setter method for id. <br>
	 * The new value is set only if compareTo() says it is different, or if one
	 * of either the new value or the current value is null. In case the new
	 * value is different, it is set and the field is marked as 'modified'.
	 *
	 * @param newVal
	 *            the new value to be assigned to id
	 */
	...
	public boolean isModified() {
		return duracaoIsModified || authIsModified || utilizadorIdIsModified
				|| idIsModified;
	}
	...
	public Map<String, String> getDictionnary() {
		...
		dictionnary.put("duracao", getDuracao() == null ? "" : getDuracao()
				.toString());
		dictionnary.put("auth", getAuth() == null ? "" : getAuth().toString());
		dictionnary.put("utilizador_id", getUtilizadorId() == null ? ""
				: getUtilizadorId().toString());
	...
	public String getValue(String column) {
		if (null == column || "".equals(column)) {
			return "";
		} else if ("duracao".equalsIgnoreCase(column)
				|| "duracao".equalsIgnoreCase(column)) {
			return getDuracao() == null ? "" : getDuracao().toString();
		} else if ("auth".equalsIgnoreCase(column)
				|| "auth".equalsIgnoreCase(column)) {
			return getAuth() == null ? "" : getAuth().toString();
		} else if ("utilizador_id".equalsIgnoreCase(column)
				|| "utilizadorId".equalsIgnoreCase(column)) {
			return getUtilizadorId() == null ? "" : getUtilizadorId()
					.toString();
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(getDuracao(), obj.getDuracao())
				.append(getAuth(), obj.getAuth())
				.append(getUtilizadorId(), obj.getUtilizadorId())
				.append(getId(), obj.getId()).isEquals();
	}
	 ...
	 */
	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973).append(getDuracao())
				.append(getAuth()).append(getUtilizadorId()).append(getId())
				.toHashCode();
	}
	...
	public String toString(ToStringStyle style) {
		return new ToStringBuilder(this, style).append("duracao", getDuracao())
				.append("auth", getAuth())
	...
	public int compareTo(Object object) {
		AutenticacaoBean obj = (AutenticacaoBean) object;
		return new CompareToBuilder().append(getDuracao(), obj.getDuracao())
				.append(getAuth(), obj.getAuth())
				.append(getUtilizadorId(), obj.getUtilizadorId())
				.append(getId(), obj.getId()).toComparison();
	}
}
