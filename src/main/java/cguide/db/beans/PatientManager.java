...
public class PatientManager {
	public static final String ALL_FIELDS = "time" + ",email" + ",type"
			+ ",homephone" + ",phone" + ",address" + ",birthdate" + ",nutente"
			+ ",lastname" + ",name" + ",idpatient";
	public static final String FIELDS = "time" + ",email" + ",type"
			+ ",homephone" + ",phone" + ",address" + ",birthdate" + ",nutente"
			+ ",lastname" + ",name";
	public static final String[] ALL_FIELDS_ARRAY = { ",time=", ",email=",
			",type=", ",homephone=", ",phone=", ",address=", ",birthdate=",
			",nutente=", ",lastname=", ",name=", "idpatient=" };
