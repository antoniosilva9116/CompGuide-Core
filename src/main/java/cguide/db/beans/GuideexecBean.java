...
public class GuideexecBean implements Serializable {
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(getTime(), obj.getTime())
				...
				.append(getStart(), obj.getStart()).isEquals();
	}

	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973).append(getTime())
				.append(getIdpatient()).append(getIduser())
				.append(getIdguideline()).append(getIdguideline())
				.append(getIdguideexec()).append(getNextTasks())
				.append(getCompleted()).append(getDescription())
				.append(getStart()).toHashCode();
	}
	...
	public String toString(ToStringStyle style) {
		...
		.append("time", getTime()).append("idpatient", getIdpatient())
				...
				.append("start", getStart()).toString();
	}

	public int compareTo(Object object) {
		GuideexecBean obj = (GuideexecBean) object;
		return new CompareToBuilder().append(getTime(), obj.getTime())
				.append(getIdpatient(), obj.getIdpatient())
				.append(getIduser(), obj.getIduser())
				.append(getIdguideline(), obj.getIdguideline())
				.append(getIdguideexec(), obj.getIdguideexec())
				.append(getNextTasks(), obj.getNextTasks())
				.append(getCompleted(), obj.getCompleted())
				.append(getDescription(), obj.getDescription()).toComparison();
	}
