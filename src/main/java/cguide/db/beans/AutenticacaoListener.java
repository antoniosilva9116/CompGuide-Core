...
public interface AutenticacaoListener {
	/**
	 * Invoked just before inserting a AutenticacaoBean record into the
	 * database.
	 *
	 * @param bean
	 *            the AutenticacaoBean that is about to be inserted
	 */
	 ...
	 *
	 * @param bean
	 *            the AutenticacaoBean that was just inserted
	 */
	 ...
	 *
	 * @param bean
	 *            the AutenticacaoBean that is about to be updated
	 */
	 ...
	 *
	 * @param bean
	 *            the AutenticacaoBean that was just updated
	 */
	 ...
	 *
	 * @param bean
	 *            the AutenticacaoBean that is about to be deleted
	 */
	 ...
	 *
	 * @param bean
	 *            the AutenticacaoBean that was just deleted
	 */
