...
/**
 * The Manager provides connections and manages transactions transparently. <br>
...
public final class Manager {
		...
		try {
			...
			try {
				if (bundle.getString("jdbc.datasourceString") != null
					...
					System.out
							.println("A datasourceString was found and will be used instead of jdbc settings from file: "
									+ fileName);
				...
				System.out
						.println("An exception was found while setting data source.");
			}
			System.out.println("Trying to set the jdbc values from file: "
					+ fileName);
			...
			System.err.println("The property file " + fileName
					+ " could not be found.");
			throw new DAOException(ioe.getMessage(), ioe);
		} catch (ClassNotFoundException cnfe) {
			System.err.println("The driver class " + this.jdbcDriver
					+ " could not be found.");
	...
	/**
	 * Sets the datasource to be used by the manager. <br>
	...
	/**
	 * Loads the passed jdbc driver. <br>
	 * Only needed if the datasource is not set.
	 */
	public void setJdbcDriver(String jdbcDriver) throws ClassNotFoundException,
	...
	/**
	 * Sets the username used to access the database. <br>
	 * Only needed if the datasource is not set.
	 */
	...
	/**
	 * Sets the password used to access the database. <br>
	 * Only needed if the datasource is not set.
	 */
	...
	/**
	 * Gets an auto commit connection. <br>
	...
	public Connection getConnection() throws SQLException {
		synchronized (transactionConnection) {
			...
			} else if (jdbcDriver != null && jdbcUrl != null
	...
	/**
	 * Releases the database connection. <br>
	...
	/**
	 * Initiates a database transaction. <br>
	...
	/**
	 * Sets the PrintWriter where logs are printed. <br>
	 * You may pass 'null' to disable logging.
	 *
	 * @param pw
	 *            the PrintWriter for log messages
	 */
	 ...
	 * null.
	 */
	public static void setInteger(PreparedStatement ps, int pos, Integer i)
			throws SQLException {
		if (i == null) {
	 ...
	 * null.
	 */
	public static void setFloat(PreparedStatement ps, int pos, Float f)
			throws SQLException {
		if (f == null) {
	 ...
	 * null.
	 */
	public static void setDouble(PreparedStatement ps, int pos, Double d)
			throws SQLException {
		if (d == null) {
	 ...
	 */
	public static void setLong(PreparedStatement ps, int pos, Long l)
			throws SQLException {
		if (l == null) {
	 ...
	 * null.
	 */
	public static void setBoolean(PreparedStatement ps, int pos, Boolean b)
			throws SQLException {
		if (b == null) {
	 ...
	 * Retrieves a date value from the passed result set as a Calendar object.
	 */
	public static Calendar getCalendar(ResultSet rs, String column)
			throws SQLException {
		Calendar calendar = Calendar.getInstance();
		try {
	 ...
	 * null.
	 */
	public static void setCalendar(PreparedStatement ps, int pos,
	...
	private static void setValueRepresentingNull(Calendar calendar) {
		...
		calendar.set(Calendar.ZONE_OFFSET,
				(calendar.getTimeZone().getRawOffset() + calendar.getTimeZone()
						.getDSTSavings()) / 60000);
	}
	...
	private static final String[] PATTERNS = new String[] {
			...
			"EEE, dd MMM yyyy HH:mm:ss '+'S '('z')'",
			"EEE, dd MMM yyyy HH:mm:ss '-'S", "EEE, dd MMM yyyy HH:mm:ss '+'S",
			"EEE, dd MMM yyyy HH:mm:ss z", "EEE, dd MMM yyyy HH:mm:ss Z",
			"EEE, dd MMM yyyy HH:mm:ss",
			"EEE, d MMM yyyy HH:mm:ss '-'S '('z')'",
			"EEE, d MMM yyyy HH:mm:ss '+'S '('z')'",
			"EEE, d MMM yyyy HH:mm:ss '-'S", "EEE, d MMM yyyy HH:mm:ss '+'S",
			"EEE, d MMM yyyy HH:mm:ss z", "EEE, d MMM yyyy HH:mm:ss Z",
			"EEE, d MMM yyyy HH:mm:ss",

			"EEE, dd MMM yy HH:mm:ss '-'S '('z')'",
			"EEE, dd MMM yy HH:mm:ss '+'S '('z')'",
			"EEE, dd MMM yy HH:mm:ss '-'S", "EEE, dd MMM yy HH:mm:ss '+'S",
			"EEE, dd MMM yy HH:mm:ss z", "EEE, dd MMM yy HH:mm:ss Z",
			"EEE, dd MMM yy HH:mm:ss", "EEE, d MMM yy HH:mm:ss '-'S '('z')'",
			"EEE, d MMM yy HH:mm:ss '+'S '('z')'",
			"EEE, d MMM yy HH:mm:ss '-'S", "EEE, d MMM yy HH:mm:ss '+'S",
			"EEE, d MMM yy HH:mm:ss z", "EEE, d MMM yy HH:mm:ss Z",
			"EEE, d MMM yy HH:mm:ss",

			"dd MMM yyyy HH:mm:ss '-'S", "dd MMM yyyy HH:mm:ss '+'S",
			"dd MMM yyyy HH:mm:ss '-'S '('z')'",
			"dd MMM yyyy HH:mm:ss '+'S '('z')'", "dd MMM yyyy HH:mm:ss z",
			"dd MMM yyyy HH:mm:ss Z", "dd MMM yyyy HH:mm:ss",

			"dd MMM yyy HH:mm:ss '-'S", "dd MMM yyy HH:mm:ss '+'S",
			"dd MMM yyy HH:mm:ss '-'S '('z')'",
			"dd MMM yyy HH:mm:ss '+'S '('z')'", "dd MMM yyy HH:mm:ss z",
			"dd MMM yyy HH:mm:ss Z", "dd MMM yyy HH:mm:ss",

			"yyyy.MM.dd HH:mm:ss z", "yyyy.MM.dd HH:mm:ss Z",
			"yyyy.MM.d HH:mm:ss z", "yyyy.MM.d HH:mm:ss Z",
			"yyyy.MM.dd HH:mm:ss", "yyyy.MM.d HH:mm:ss",

			"yy.MM.dd HH:mm:ss z", "yy.MM.dd HH:mm:ss Z", "yy.MM.d HH:mm:ss z",
			"yy.MM.d HH:mm:ss Z", "yy.MM.dd HH:mm:ss", "yy.MM.d HH:mm:ss",

			"yyyy MM dd HH:mm:ss", "yyyy MM d HH:mm:ss",
			"yyyy MM dd HH:mm:ss z", "yyyy MM dd HH:mm:ss Z",
			"yyyy MM d HH:mm:ss z", "yyyy MM d HH:mm:ss Z",

			"yy MM dd HH:mm:ss", "yy MM d HH:mm:ss", "yy MM dd HH:mm:ss z",
			"yy MM dd HH:mm:ss Z", "yy MM d HH:mm:ss z", "yy MM d HH:mm:ss Z",
	 ...
	 * 
	 * @param strDate
	 *            the date as string. If (null or empty) or correct pattern was
	 *            not found
	 * @return Date object
	 */
		...
		if (!"".equals(strDate)) {
			for (String pattern : PATTERNS) {
				try {
					...
					java.util.Date dReceivedDate = pSimpleDateFormat
							.parse(strDate);
					if (dReceivedDate == null) {
						continue;
					}
	...
	public static String buildProcedureCall(String packageName,
			String procedureName, int paramCount) {
	...
	public static String buildProcedureCall(String procedureName, int paramCount) {
		StringBuilder sb = new StringBuilder("{call ").append(procedureName)
				.append("(");
