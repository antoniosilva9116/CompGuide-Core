...
public class GeneratedTaskManager {
	public static final String ALL_FIELDS = "identifier" + ",idsync"
			+ ",idplan" + ",idguideexec" + ",idgeneratedTask";

	public static final String FIELDS = "identifier" + ",idsync" + ",idplan"
			+ ",idguideexec";

	public static final String[] ALL_FIELDS_ARRAY = { "identifier=",
			",idsync=", ",idplan=", ",idguideexec=", "idgeneratedTask=" };
	...
	public GeneratedTaskBean getGeneratedTaskBeanBeanByID(String id) {
		...
		PreparedStatement statement = null;
		StringBuilder sql = null;
		GeneratedTaskBean bean = GeneratedTaskManager.getInstance()
				.createGeneratedTaskBean();
		ResultSet rs = null;
	...
	public ArrayList<TaskQuadruple> getGeneratedTaskBeanListBeanByID(
