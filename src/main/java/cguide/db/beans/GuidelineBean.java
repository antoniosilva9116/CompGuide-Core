...
/**
 * Created with IntelliJ IDEA. User: tiago Date: 31-07-2013 Dateofcreation:
 * 13:19 To change this template use File | Settings | File Templates.
 */
public class GuidelineBean implements Serializable {
	...
	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973)
				.append(getIdguideexec()).append(getDateofcreation())
				.append(getGuidelinename()).append(getVersionnumber())
				.append(getIdguideline()).append(getDateofupdate())
				.append(getAuthorship()).append(getIdentifier()).toHashCode();
	}
	 ...
	 * ToStringStyle.NO_FIELD_VERSIONNUMBERS_STYLE</li> <li>
