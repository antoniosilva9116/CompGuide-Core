...
public class ObservationManager {
	public static final String ALL_FIELDS = "idtask" + ",time" + ",identifier"
			+ ",parametervalue" + ",variablename" + ",parameteridentifier"
			+ ",isnumeric" + ",unit" + ",parameter" + ",idobservation";
	public static final String FIELDS = "idtask" + ",time" + ",identifier"
			+ ",parametervalue" + ",variablename" + ",parameteridentifier"
			+ ",isnumeric" + ",unit" + ",parameter";
	public static final String[] ALL_FIELDS_ARRAY = { "idtask=", ",time=",
			",identifier=", ",parametervalue=", ",variablename=",
			",parameteridentifier=", ",isnumeric=", ",unit=", ",parameter=",
			"idobservation=" };
	...
	public ObservationBean getObservationBeanByID(Long id) {
		...
		PreparedStatement statement = null;
		StringBuilder sql = null;
		ObservationBean bean = ObservationManager.getInstance()
	 ...
	 *
	 * @param bean
	 *            the UtilizadorBean bean to be saved
	...
	public ObservationBean update(ObservationBean bean) throws DAOException {
		...
		try {
			...
			sql = new StringBuilder();
			// bean=
			// ObservationManager.getInstance().getObservationBeanByID(4L);
	...
	/**
	 * Update the UtilizadorBean bean record in the database according to the
	 * changes.
	 *
	 * @param bean
	 *            the UtilizadorBean bean to be updated
	...
	public ArrayList<Condition> getParameterByIdguideexec(Long id)
			throws DAOException {
		Connection c = null;
		PreparedStatement ps = null;
		StringBuilder sql = new StringBuilder();
		...
		try {
			...
			while (rs.next()) {
				...
				condition.addParameterIdentifier(rs
						.getString("parameterIdentifier"));
				str.add(condition);
