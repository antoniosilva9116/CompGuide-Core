...
public class PatientBean implements Serializable {
	...
	/**
	 * Prefered methods to create a PatientBean is via the createUtilizadorBean
	...
	public Map<String, String> getDictionnary() {
		...
		dictionnary.put("idpatient", getIdpatient() == null ? ""
	...
	public String getValue(String column) {
		...
		} else if ("nutente".equalsIgnoreCase(column)
				|| "nutente".equalsIgnoreCase(column)) {
			return getName() == null ? "" : getName().toString();
		} else if ("idpatient".equalsIgnoreCase(column)
				|| "idpatient".equalsIgnoreCase(column)) {
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(getType(), obj.getType())
				...
				.append(getIdpatient(), obj.getIdpatient()).isEquals();
	}
	 ...
	 */
	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973).append(getType())
				.append(getEmail()).append(getHomephone()).append(getPhone())
				.append(getAddress()).append(getBirthdate())
				.append(getLastname()).append(getName()).append(getNutente())
				.append(getIdpatient()).toHashCode();
	}
	...
	public String toString(ToStringStyle style) {
		return new ToStringBuilder(this, style).append("type", getType())
				...
				.append("idpatient", getIdpatient()).toString();
	}

	public int compareTo(Object object) {
		PatientBean obj = (PatientBean) object;
		return new CompareToBuilder().append(getType(), obj.getType())
				.append(getEmail(), obj.getEmail())
				.append(getHomephone(), obj.getHomephone())
				.append(getPhone(), obj.getPhone())
				.append(getAddress(), obj.getAddress())
				...
				.append(getName(), obj.getName())
				.append(getNutente(), obj.getNutente())
				.append(getIdpatient(), obj.getIdpatient()).toComparison();
	}
