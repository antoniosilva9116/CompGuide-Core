...
public class MedicationBean implements Serializable {
	...
	/**
	 * Prefered methods to create a MedicationBean is via the
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(getIdtask(), obj.getIdtask())
				...
				.append(getIdentifier(), obj.getIdentifier()).isEquals();
	}
	...
	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973).append(getIdtask())
				.append(getTime()).append(getDescription())
				.append(getPosology()).append(getPharmaceuticalform())
				.append(getDosage()).append(getActiveingredient())
				.append(getName()).append(getIdmedication())
	...
	public String toString(ToStringStyle style) {
		return new ToStringBuilder(this, style).append("idtask", getIdtask())
				...
				.append("identifier", getIdentifier()).toString();
	}
	...
	public int compareTo(Object object) {
		...
		return new CompareToBuilder().append(getIdtask(), obj.getIdtask())
				...
				.append(getName(), obj.getName())
				.append(getIdmedication(), obj.getIdmedication())
				.append(getIdentifier(), obj.getIdentifier()).toComparison();
	}
