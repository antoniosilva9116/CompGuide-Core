...
public class AutenticacaoComparator implements Comparator {
	...
	/**
	 * Constructor class for AutenticacaoComparator. <br>
	 * Example: <br>
	 * <code>Arrays.sort(pArray, new AutenticacaoComparator(AutenticacaoManager.ID_DURACAO, bReverse));<code>
	 *
	 * @param iType
	 *            the field from which you want to sort <br> Possible values
	 *            are: <ul> <li>AutenticacaoManager.ID_DURACAO
	 *            <li>AutenticacaoManager.ID_AUTH
	 *            <li>AutenticacaoManager.ID_UTILIZADOR_ID
	 *            <li>AutenticacaoManager.ID_ID </ul>
	 */
	 ...
	 *
	 * @param bReverse
	 *            set this value to true, if you want to reverse the sorting
	 *            results
	 */
	...
	public int compare(Object pObj1, Object pObj2) {
		...
		case AutenticacaoManager.ID_UTILIZADOR_ID:
			if (b1.getUtilizadorId() == null && b2.getUtilizadorId() != null) {
				iReturn = -1;
			} else if (b1.getUtilizadorId() == null
					&& b2.getUtilizadorId() == null) {
				iReturn = 0;
			} else if (b1.getUtilizadorId() != null
					&& b2.getUtilizadorId() == null) {
				iReturn = 1;
