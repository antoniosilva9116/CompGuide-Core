...
public class UserManager {
	public static final String ALL_FIELDS = "active" + ",reg"
			+ ",activationkey" + ",type" + ",photo" + ",email" + ",homephone"
			+ ",phone" + ",address" + ",birthdate" + ",lastname" + ",name"
			+ ",password" + ",username" + ",iduser";
	public static final String FIELDS = "active" + ",reg" + ",activationkey"
			+ ",type" + ",photo" + ",email" + ",homephone" + ",phone"
			+ ",address" + ",birthdate" + ",lastname" + ",name" + ",password"
			+ ",username";
	public static final String[] ALL_FIELDS_ARRAY = { "active=", ",reg=",
			",activationkey=", ",type=", ",photo=", ",email=", ",homephone=",
			",phone=", ",address=", ",birthdate=", ",lastname=", ",name=",
			",password=", ",username=", "iduser=" };
