...
public class Condition {
	...
	public void setTemporalRestriction(
			ArrayList<TemporalRestriction> temporalRestriction) {
	...
	public Boolean conditionCompare(Condition c) {
		return (this.getComparisonOperator().equals(c.getComparisonOperator())
				&& this.getValue().equals(c.getValue()) && this
				.getConditionParameter().equals(c.getConditionParameter()));
	}
	...
	public Boolean conditionCompareNumeric(Condition c) {
		...
		if (c.getComparisonOperator().equals("Different_from")) {
			if (!c.getValue().equals(c.getValue()))
				test = Boolean.TRUE;
		}
		...
		return (c.getUnit().equals(this.getUnit()) && test && this
				.getConditionParameter().equals(c.getConditionParameter()));
	}
