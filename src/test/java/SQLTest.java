...
public class SQLTest {
	...
	public static final String FIELDS = "active" + ",activationkey" + ",type"
			+ ",photo" + ",email" + ",homephone" + ",phone" + ",adress"
			+ ",birthdate" + ",lastname" + ",name" + ",password" + ",username";
	public static final String[] ALL_FIELDS_ARRAY = { "active=", ",type=",
			",photo=", ",email=", ",homephone=", ",phone=", ",adress=",
			",birthdate=", ",lastname=", ",name=", ",password=", ",username=",
			"iduser=" };
	...
	public static void main(String[] argv) throws SQLException {
		 ...
		 * controller.addTask(new TaskTriple("b", "b", "e"));
		 * controller.addTask(new TaskTriple("b", "b", "e"));
		 * controller.pushSync("c"); controller.pushSync("d");
		 * controller.pushSync("e"); System.out.println("PEEK=" +
		 * controller.getSyncTask().peek());
		...
		/*
		 * GeneratedTaskBean bean =
		 * GeneratedTaskManager.getInstance().createGeneratedTaskBean();
		 * bean.setIdentifier("jose"); bean.setIdplan(123123123L);
		 * bean.setIdsync(123123123L); bean.setIdguideexec(219L);
		...
		ids.add("2");
		ids.add("3");
		generatedTaskBeans = GeneratedTaskManager.getInstance()
				.getGeneratedTaskBeanListBeanByID(ids);
		Gson gson = new Gson();
